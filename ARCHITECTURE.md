# Architecture Specification: UniERP Multi-Tenant Hosted Customer Sites (`tenant-sites`)
...
```mermaid
graph LR
  Callers["Allowed Inbound Callers<br/>Tenant end-customers, partners"] --> Repo["<b>tenant-sites (L4)</b><br/>UniERP Multi-Tenant Hosted Customer Sites"]
...
### Boundary Contract
- **Allowed Inbound Consumers**: Tenant end-customers, partners
...
- **Primary Interface**: `@kannan19302/tenant-sites`
...
- **Project Skill**: [`.agents/skills/tenant-sites-standards/SKILL.md`](.agents/skills/tenant-sites-standards/SKILL.md)
